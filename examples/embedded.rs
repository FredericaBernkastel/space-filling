...
pub fn report_progress<'a>(iter: impl Iterator<Item = (ArgmaxResult, &'a mut Argmax2D)>, nth: usize)
  -> impl Iterator<Item = (ArgmaxResult, &'a mut Argmax2D)> {
  iter.enumerate()
